...
export function SiteFooter() {
  return (
    <footer className="bg-black text-white py-16 px-8 lg:px-[4vw] lg:py-24">
      <div className="flex flex-col justify-between gap-16 lg:flex-row">
        {/* Left Section - Newsletter Signup */}
        <div className="max-w-3xl flex flex-col gap-16 w-full">
          <div className="flex flex-col gap-8">
            <div className="text-3xl lg:leading-tight lg:text-5xl font-abc-whyte">
              Subscribe to get tips and tactics to grow the way you want.
            </div>
            <div className="relative cursor-pointer">
              <Image
                src="/email-input.svg"
                alt="Email subscription input"
                width={666}
                height={40}
                className="w-full max-w-[666px] h-10"
                priority
              />
              <input
                name="email"
                ...
                type="email"
                className="absolute left-4 top-0 w-[calc(100%-120px)] h-full bg-transparent text-black placeholder-gray-500 focus:outline-none font-abc-whyte"
              />
            </div>
          </div>

          <div className="flex items-center gap-2 font-abc-whyte">
            <Image src="/gumroad-logo.png" alt="Gumroad logo" width={24} height={24} className="w-6 h-6" />
            <div className="text-gray-400">Ⓒ Gumroad Inc.</div>
          </div>
        </div>
        ...
        <div className="max-w-3xl flex flex-col w-full gap-16">
          <div className="flex-1 flex gap-16">
            {/* First Column */}
            <div className="flex-1 flex flex-col gap-3 font-abc-whyte">
              <a href="/discover" className="text-white no-underline hover:text-custom-pink transition-colors">
                Discover
              </a>
              <a href="/blog" className="text-white no-underline hover:text-custom-pink transition-colors">
                Blog
              </a>
              <a href="/pricing" className="text-white no-underline hover:text-custom-pink transition-colors">
                Pricing
              </a>
              <a href="/features" className="text-white no-underline hover:text-custom-pink transition-colors">
                Features
              </a>
              <a href="/about" className="text-white no-underline hover:text-custom-pink transition-colors">
                About
              </a>
              <a href="#" className="text-white no-underline hover:text-custom-pink transition-colors">
                Small Bets
              </a>
            </div>
            ...
            {/* Second Column */}
            <div className="flex-1 flex flex-col gap-3 font-abc-whyte">
              <a href="/help" className="text-white no-underline hover:text-custom-pink transition-colors">
                Help
              </a>
              <a href="#" className="text-white no-underline hover:text-custom-pink transition-colors">
                Board meetings
              </a>
              <a href="/terms" className="text-white no-underline hover:text-custom-pink transition-colors">
                Terms of Service
              </a>
              <a href="/privacy" className="text-white no-underline hover:text-custom-pink transition-colors">
                Privacy Policy
              </a>
            </div>
          </div>
          ...
          {/* Social Media Icons */}
          <div className="flex justify-between font-abc-whyte">
            <a href="https://x.com/gumroad" className="text-white hover:text-custom-pink transition-colors">
            ...
            <a href="https://www.facebook.com/gumroad" className="text-white hover:text-custom-pink transition-colors">
            ...
            <a href="http://pinterest.com/gumroad" className="text-white hover:text-custom-pink transition-colors">
      ...
      <div className="fixed bottom-6 right-6">
        <button className="w-12 h-12 bg-custom-pink hover:bg-custom-pink/90 rounded-full flex items-center justify-center shadow-lg transition-colors font-abc-whyte">
          <span className="sr-only font-abc-whyte">Open chat</span>
